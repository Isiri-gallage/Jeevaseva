...
import {
  Droplets, Heart, Clock, MapPin,
  Building2, Phone, Search
} from 'lucide-react';
    ...
    <Layout>
      ...
      <div style={styles.infoCard}>
        ...
        <p style={styles.infoText}>
          As a <strong>{user?.blood_type}</strong> donor, you can donate to patients
          who need compatible blood types. All requests below are compatible with your blood type.
        </p>
      </div>
...
const styles = {
  ...
  infoCard: { display: 'flex', alignItems: 'center', gap: '12px', backgroundColor: '#FADBD8', borderRadius: '12px', padding: '16px 20px', marginBottom: '24px' },
