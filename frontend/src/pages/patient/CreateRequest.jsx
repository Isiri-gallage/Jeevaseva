      ...
      <div style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          {[
            ...
            { icon: <Plus size={18} />, label: 'Create Request', path: '/create-request', active: true },
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.section}>
              ...
              <div style={styles.row}>
                ...
                <div style={styles.inputGroup}>
                  ...
                  <input
                    type="number" name="units_needed" min="1" max="10"
                    value={form.units_needed} onChange={handleChange}
            ...
            <div style={styles.section}>
              ...
              <div style={styles.inputGroup}>
                ...
                <input
                  type="text" name="hospital_name" value={form.hospital_name}
                  onChange={handleChange} placeholder="e.g. National Hospital Colombo"
                  style={styles.input} required
                />
              </div>
              <div style={styles.row}>
                <div style={{ ...styles.inputGroup, flex: 2 }}>
                  ...
                  <input
                    type="text" name="hospital_address" value={form.hospital_address}
            ...
            <div style={styles.section}>
              ...
              <div style={styles.row}>
                <div style={styles.inputGroup}>
                  ...
                  <input
                    type="text" name="patient_name" value={form.patient_name}
                    onChange={handleChange} placeholder="Full name of patient"
                    style={styles.input} required
                  />
                </div>
                <div style={styles.inputGroup}>
                  ...
                  <input
                    type="text" name="contact_number" value={form.contact_number}
...
const styles = {
  ...
  sectionTitle: {
    fontSize: '18px', fontFamily: 'Playfair Display, serif', color: '#2C3E50',
    paddingBottom: '12px', borderBottom: '2px solid #F2F3F4',
  },
  ...
  input: {
    ...
    fontSize: '15px', fontFamily: 'DM Sans, sans-serif', backgroundColor: '#F9F9F9', width: '100%',
  },
  textarea: {
    padding: '12px 16px', borderRadius: '10px', border: '2px solid #E8E8E8',
  ...
  cancelBtn: {
    padding: '14px 28px', borderRadius: '10px', border: '2px solid #E8E8E8',
    backgroundColor: 'white', color: '#7F8C8D', fontSize: '15px',
    fontWeight: '500', cursor: 'pointer', fontFamily: 'DM Sans, sans-serif',
  },
  submitBtn: {
    display: 'flex', alignItems: 'center', gap: '8px',
    padding: '14px 28px', borderRadius: '10px', backgroundColor: '#C0392B',
  ...
  submitBtnDisabled: {
    display: 'flex', alignItems: 'center', gap: '8px',
    padding: '14px 28px', borderRadius: '10px', backgroundColor: '#E74C3C80',
    color: 'white', fontSize: '15px', fontWeight: '500', cursor: 'not-allowed',
    border: 'none', fontFamily: 'DM Sans, sans-serif',
  },
};
